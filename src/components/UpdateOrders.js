    ...
    return (
      <div className="container">
        <div className="update-order">
          ...
          <p>
            Step 2: Please see above for order details. Please add items to your
            order using the check box and remove using the 'X' button.
          </p>
          <div>
            <p>
              Step 3: Please click submit or delete when you are ready to submit
              changes to your order.
            </p>
            <button
              className="btn-white"
              style={{ width: 250 }}
              onClick={() => this.submitUpdatedOrder()}
            >
              SUBMIT UPDATED ORDER
            </button>
            <button
              className="btn-red"
              onClick={() => this.submitDeleteOrder()}
            >
              DELETE ENTIRE ORDER
            </button>
          </div>
